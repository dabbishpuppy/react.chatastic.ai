...
const EnhancedWebsiteCrawlFormV3: React.FC<EnhancedWebsiteCrawlFormV3Props> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await submitWebsite({
        ...
        maxPages: 10000, // Set to very high limit
        maxDepth: 10, // Set to very high limit
        respectRobots: false, // Disable robots.txt restrictions
  ...
  const getTabDescription = () => {
    switch (activeTab) {
      case 'website':
        return 'Crawl an entire website with comprehensive discovery and filtering options.';
      case 'single-site':
