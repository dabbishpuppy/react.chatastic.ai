    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-xl font-semibold text-gray-900">Add Website Source</h3>
          <p className="text-sm text-gray-600 mt-1">Crawl websites to add content to your knowledge base</p>
        </div>
                  ...
                  <AccordionContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Select value={maxPages.toString()} onValueChange={value => setMaxPages(parseInt(value))} disabled={isSubmitting}>
                      ...
                      {activeTab === 'website' && (
                        <div>
                          ...
                          <Select value={maxDepth.toString()} onValueChange={value => setMaxDepth(parseInt(value))} disabled={isSubmitting}>
                            <SelectTrigger className="mt-1">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
