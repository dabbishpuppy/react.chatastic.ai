...
export const getStatusColor = (status: string): string => {
  switch (status) {
    ...
    case 'trained': return 'bg-green-100 text-green-800 border-green-200';
    case 'in_progress': return 'bg-blue-100 text-blue-800 border-blue-200';
    case 'recrawling': return 'bg-orange-100 text-orange-800 border-orange-200';
...
export const getStatusText = (status: string): string => {
  switch (status) {
    ...
    case 'recrawling': return 'Recrawling';
